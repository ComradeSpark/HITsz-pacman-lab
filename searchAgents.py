...
class PositionSearchProblem(search.SearchProblem):
    ...
    def __init__(self, gameState: pacman.GameState, costFn = lambda x: 1, goal=(1,1), start=None, warn=True, visualize=True):
        """
...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState: pacman.GameState, visualize=True):
        """
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    for food in food_list:
        dis_list.append(mazeDistance(position, food, problem.startingGameState))
